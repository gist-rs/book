...
- TikTok: [Rewriting a `Go` service to `Rust` 🦀 led to 2x performance, 72% less memory usage, and saving nearly $300k annually](https://wxiaoyun.com/blog/rust-rewrite-case-study/)
