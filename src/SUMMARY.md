...
- [Rust](rust/mod.md)
  ...
  - [R4 - Basic](rust/r4/mod.md)
    ...
    - [Handle multiple results and options](rust/r4/40-handle-multiple-result-option.md)
  ...
  - [R3 - Advanced](rust/r3/mod.md)
    ...
    - [Traits](rust/r3/trait.md)
    - [Serde](rust/r3/serde.md)
    - [Enums](rust/r3/enum.md)
  ...
  - [R2 - Expert](rust/r2/mod.md)
    ...
    - [Hello Cloudflare Container](rust/r2/hello-cloudflare-container.md)
